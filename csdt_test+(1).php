...
$featurearray = array("Gender" => array("Male","Female","Trans / Non-Binary"),"Race" => array("White","Black","Chinese","South Asian","Indigenous"),"Sexual Orientation" => array("Heterosexual / Straight","Homosexual / LGBTQ+"),"Political Experience" => array("No Political Experience","Local Municipal Councillor","One-term Member of Parliament"),"Community Activities" => array("Organizer of Local Food Bank","Member of Chamber of Commerce","Volunteer at Ethnic Cultural Community Centre","Activist with LGBT Advocacy Group"),"Age" => array("57","42","27"),"Party" => array("Liberal","Conservative","NDP"));
